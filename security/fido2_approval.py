#!/usr/bin/env python3
"""
AIOHAI Stage 2: FIDO2/WebAuthn Hardware Approval System

Provides physical-presence verification for TIER 3 operations using:
...
Architecture:
  AIOHAI Proxy --> FIDO2 Approval Server --> Web Interface --> User Device
       |                     |                        |
       |  POST /api/request  |  WebAuthn challenge    |  Face ID / Touch / NFC
       |                     |                        |
       |  Poll /api/status   |  Signed assertion      |  Biometric confirmation
       |                     |                        |
       +---------------------+------------------------+
...
# =============================================================================
# HTML TEMPLATES (separate file for cleanliness)
# =============================================================================
